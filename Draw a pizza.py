...
screen.title("The pizza's all yours!")
...
def move_turtle(x, y):
    my_turtle.up()  # can also be written as my_turtle.penup()
    my_turtle.goto(x, y)
    my_turtle.down()
...
move_turtle(0, 25) # move a bit up
draw_circle(125, SAUCE_COLOR, CHEESE_COLOR)

for locations in PEPPERONI_LOCATIONS:
    move_turtle(locations[0], locations[1])
    draw_circle(10, SAUCE_COLOR, SAUCE_COLOR)
    
move_turtle(0, 150) # Move to the center of circle
